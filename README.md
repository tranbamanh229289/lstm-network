...
## Khi một vector đi qua mạng neuron, chúng trải qua rất nhiều phép tính và trong quá trình đó sẽ có thành phần nào đó trở nên quá to và khiến các thành phần khác trở nên không đáng kể. Hàm tanh lúc này. sẽ giúp tinh chỉnh sự chênh lệch này để giúp "các thành phần yếu thế vẫn có tiếng nói trong xã hội".Vậy chúng ta sẽ chuyển các giá trị của bài toán học có giám sát trong khoảng (-1,1) bằng hàm tanh 
